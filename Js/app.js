...
const cartTotle = document.querySelector('.cart-total');
const cartContent = document.querySelector('.cart-content');
const productsBom = document.querySelector('.products-center');
...
class UI{
        ...
        buttons.forEach(button => {
            ...
            if(inCart){
                ...
                button.addEventListener('click', (event) => {
                    ...
                    let cartItem = {...Storage.getPorduct(id),
                    amount: 1};
    ...
    setCartValues(cart) {
        ...
        cartTotle.innerText = parseFloat(tempTotal.toFixed
            (2));
...
//get all products
products.getPorducts().then(products => {
